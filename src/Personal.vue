<template>
    <div id="personal" v-if="username">
        <ul class="nav nav-tabs" role="tablist">
            <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#home" role="tab">Заказы</a>
            </li>
        </ul>
        <div class="tab-content">
            ...
            <div class="tab-pane" id="profile" role="tabpanel">Аккаунт</div>
        </div>
    </div>
</template>
    ...
    export default {
        ...
        mounted: function () {
            this.$nextTick(function () {
                $('#personal .nav-item').click(function (e) {
                    e.preventDefault();
                    $(this).tab('show')
                });
            })
